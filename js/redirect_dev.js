...
function appStoreLink() {
    ...
    if ((isMobile.Android() || isMobile.iOS()) && messageParameter && !(messageParameter === "")) {
        ...
        if(isMobile.iOS() && ((typeof localStorage.hasApp !== 'undefined' && localStorage.hasApp === 'true') || typeof localStorage.firstMessageID_dev !== 'undefined')){
...
function getMessageThumbnail(message_id, callback) {
    ...
    var base_url = "http://chatwala-dev-20.azurewebsites.net/";
